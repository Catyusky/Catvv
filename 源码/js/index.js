...
// 给搜索帮助中的每个选项添加鼠标悬停事件
searchHelper.addEventListener('mouseover', function(event) {
    // 获取鼠标悬停的元素
  ...
  // 给搜索帮助中的每个选项添加鼠标离开事件
  searchHelper.addEventListener('mouseout', function(event) {
    // 获取鼠标离开的元素
    let target = event.target;
    // 判断是否离开了搜索帮助的选项
    if (target.tagName.toLowerCase() === 'p') {
  ...
  // 给搜索帮助中的每个选项添加点击事件
searchHelper.addEventListener('click', function(event) {
    // 获取点击的元素
    let target = event.target;
    // 判断是否点击了搜索帮助的选项
    if (target.tagName.toLowerCase() === 'p') {
